...
from Rond_player import Rond_player
...
class Game:
    def __init__(self):
        ...
        player_position = tmx_data.get_object_by_name('spawn_lab1') #remplir
        self.Rond = Rond_player(player_position.x, player_position.y)
